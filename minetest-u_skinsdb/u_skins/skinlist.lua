...
while fetched_skip < 40 do
	...
	if file then
		...
		u_skins.meta[name] = {}
		u_skins.meta[name].name = minetest.formspec_escape(data[1])
		u_skins.meta[name].author = minetest.formspec_escape(data[2])
		u_skins.meta[name].license = minetest.formspec_escape(data[3])
